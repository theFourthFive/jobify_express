...
mysql_url = (process.env.MYSQL_PROTOCOL ? process.env.MYSQL_PROTOCOL : "mysql://") +
...
module.exports = {
  ...
  database: {
    ...
    logging: (environment === "development") ? (process.env.SEQUELIZE_ENABLED === "true" ? logging : false) : false 
  },
  keys: {
    google: {
